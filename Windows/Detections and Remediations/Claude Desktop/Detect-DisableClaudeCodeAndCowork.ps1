<#
    .SYNOPSIS
        Detection script that checks whether Claude Cowork and Claude Code are disabled.
    ...
    .DESCRIPTION
        ...
        value is missing, incorrect, or the policy path does not exist. Pairs with the matching
        remediation script.
...
#### Logging Variables ####
$Script:ScriptName = "Detect-DisableClaudeCodeAndCowork"
...
if ($NonCompliant) {
    ...
    Write-Output "COMPLIANT: Cowork and Claude Code are disabled."
    Stop-Transcript
    Exit 0
}
